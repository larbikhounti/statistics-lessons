**Ma définition** : La science qui développe et utilise des méthodes mathématiques pour transformer des données en information et en connaissance.

### **Les rôles des statistiques** : 
 **Statistique descriptive :** Décrit et synthétise les données (moyennes, médianes, graphiques, dispersion) : 
